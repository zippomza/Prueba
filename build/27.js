...
var CoreLoginSiteHelpPage = /** @class */ (function () {
    ...
    CoreLoginSiteHelpPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-core-login-site-help',template:/*ion-inline-start:"D:\Zippo\Documents\GitHub\moodlemobile2\src\core\login\pages\site-help\site-help.html"*/'<ion-header>\n\n    <ion-navbar core-back-button>\n\n        <ion-title>{{ \'core.login.help\' | translate }}</ion-title>\n\n\n\n        <ion-buttons end>\n\n            <button ion-button icon-only (click)="closeHelp()" [attr.aria-label]="\'core.close\' | translate">\n\n                <ion-icon name="close"></ion-icon>\n\n            </button>\n\n        </ion-buttons>\n\n    </ion-navbar>\n\n</ion-header>\n\n<ion-content padding>\n\n    <core-format-text [text]="\'core.login.helpmelogin\' | translate"></core-format-text>\n\n</ion-content>\n\n'/*ion-inline-end:"D:\Zippo\Documents\GitHub\moodlemobile2\src\core\login\pages\site-help\site-help.html"*/,
        }),
